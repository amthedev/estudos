...
function formFields() {
  return [
    ...
    { key: 'pdf_url', label: 'PDF da prova', type: 'url', width: 'half', maxLength: 2000, placeholder: 'https://…' },
    { key: 'answer_key_url', label: 'PDF do gabarito', type: 'url', width: 'half', maxLength: 2000, placeholder: 'https://…' },
