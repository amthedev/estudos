...
function formFields() {
  return [
    ...
    { key: 'pdf_url', label: 'PDF da prova', type: 'file', folder: 'provas', accept: 'document', width: 'full', maxLength: 2000, placeholder: 'https://… ou envie o arquivo' },
    { key: 'answer_key_url', label: 'PDF do gabarito', type: 'file', folder: 'provas', accept: 'document', width: 'full', maxLength: 2000, placeholder: 'https://… ou envie o arquivo' },
